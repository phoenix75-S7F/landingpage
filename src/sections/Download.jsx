...
const Download = () => {
	return (
		<section>
			<Element name="contato" className="g7 relative pb-32 pt-24 max-lg:pb-24 max-md:py-16">
				<div className="container">
					<div className="flex items-center">
						<div className="relative mr-6 flex-540 max-xl:flex-280 max-lg:flex-256 max-md:flex-100">
							<div className="mb-10">
								<img
									src="/images/pzeroDownload.png"									
									width={360}
									height={220}
									alt="pzero"
							...
							<p className="body-1 mb-10 max-w-md">
							    Experimente agora no IOS, Android, PC, Web - Seja qual for o seu estilo, nós temos o que você precisa.
							</p>
