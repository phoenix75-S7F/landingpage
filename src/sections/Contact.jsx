    ...
    <section>
      <div className="container">
          <div className="max-w-960 pricing-head_before relative mx-auto border-l border-r border-s2 bg-s1/50 pb-40 pt-28 max-xl:max-w-4xl max-lg:border-none max-md:pb-32 max-md:pt-16">
                   ...
                   {/* <div className="flex flex-row mt-14 mb-14 ml-11">
                     <p className="body-1 text-p4">
                       Rua X, Centro, Mogi das Cruzes - SP
                     </p>
                     <p className="body-1 text-p4 px-6">
                       +55 (11) 99958-47-51
                     </p>
                     <p className="body-1 text-p4">
                       sfrancoff@gmail.com
                   ...
                   <ul className="h-960 relative flex justify-around flex-grow px-[5%] border-2 border-s3 rounded-7xl max-md:hidden">
