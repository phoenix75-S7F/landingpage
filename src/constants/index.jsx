export const funcionalidades = [
  ...
  },
  {
    ...
    title: "Seu negócio integrado às principais soluções de vendas online",
...
export const details = [
  {
    id: "0",
    icon: "/images/detail-1.png",
    title: "Restaurantes, MiniMercados, Pizzarias",
  },
  {
    id: "1",
    icon: "/images/detail-2.png",
    title: "Lojas, Vestuarios",
  },
  {
    id: "2",
    icon: "/images/detail-3.png",
    title: "Auto peças, Oficinas Mecanicas",
  },
  {
    id: "3",
    icon: "/images/detail-4.png",
...
export const preços = [
  {
    ...
    features: [
      "2 Usuários",
      "PDV - Frente de Caixa",
      "Cadastro de Produtos/Serviços, Movimentações e Outros",
      "Suporte Técnico",
    ],
  ...
  },
  {
    ...
    features: [
      "5 usuários",
      "Plano ERP Intermediário e mais...",
      "Controle Financeiro",
      "SPED / SIGEP WEB",
  ...
  },
  {
    ...
    priceYearly: 2,
    caption:
      "Flexibilidade total para atender às necessidades específicas do seu negócio.",
    features: [
